    ...
    <div class="register">
        <section class="form_container">
            <div class="manage_tip">
                ...
                <el-form :model="registerUser" status-icon :rules="rules" ref="registerForm" label-width="100px"
                    class="registerForm">
                    ...
                    <el-form-item label="角色" prop="identity">
                        <el-select v-model="registerUser.identity" placeholder="请选择角色">
        ...
        methods: {
            submitForm(){
                this.$refs.registerForm.validate(valid=>{
                    if(valid){
                        this.$http.post('/api/users/register',this.registerUser).then(res=>{
                                this.$message({
                                    message: '注册成功',
                                    type: 'success'
                                })
